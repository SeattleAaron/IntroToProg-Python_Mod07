...
#   A.Acklen,5/29/2024,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
        - A.Acklen, 5.29.2024: Created the class.
    """
    ...
    def first_name(self, value: str):
        if value.isalpha() or value == '':
            ...
            raise ValueError('The first name should be alphabetical letters!')
    ...
    def last_name(self, value: str):
        if value.isalpha() or value == '':
            ...
            raise ValueError('The last name should be alphabetical letters!')
...
class Student(Person):
    ...
    AAcklen,5.29.2024,Created Class
    """
    ...
    def course_name(self, value: str):
        if len(value) < 12:
            ...
            raise ValueError('The course name is too long!')
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        AAcklen,5.29.2024,Created function
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    AAcklen,5.29.2030,Created Class
    """
    ...
    def output_menu(menu: str):
        ...
        ChangeLog: (Who, When, What)
        A.Acklen,5.29.2024,Created function
    ...
    def input_menu_choice():
        ...
        ChangeLog: (Who, When, What)
        Aacklen,5.24.2030,Created function
